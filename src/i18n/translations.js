const translations = {
  ko: {
    ...
    ageNoticeTeen: '청소년 탑승 시 안전을 위해 체중·키 정보를 선택해주세요.',
    ageNoticeCommon: '현재 질병 치료·약물 복용 중이거나 신체 불편이 있으신 분은 이용이 어렵습니다.',
    bodyInfoLabel: '체중 / 키 (해당 항목 선택)',
    weightOver70: '체중 70kg 이상',
    heightOver180: '키 180cm 이상',
  ...
  zh: {
    ...
    ageNoticeTeen: '青少年骑乘时，请选择体重/身高信息以确保安全。',
    ageNoticeCommon: '正在接受疾病治疗、服药中或身体不便者无法参与体验。',
    bodyInfoLabel: '体重 / 身高（如适用请选择）',
    weightOver70: '体重70kg以上',
    heightOver180: '身高180cm以上',
  ...
  en: {
    ...
    ageNoticeTeen: 'Please select weight/height info for teen riders to ensure safety.',
    ...
    bodyInfoLabel: 'Weight / Height (select if applicable)',
    weightOver70: 'Weight 70kg+',
    heightOver180: 'Height 180cm+',
